package com.ptg.ptgapi.webview;
...
public class PtgWebView extends WebView {
    public PtgWebView(Context context) {
        super(context);
        this.init(context);
    }

    public PtgWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context);

    }

    public PtgWebView(Context context, AttributeSet attrs, int defStyleAttr) {
