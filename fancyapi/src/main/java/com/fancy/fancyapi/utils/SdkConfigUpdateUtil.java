...
import com.fancy.adsdk.lib.constants.Constant;
...
//                                        Logger.w("Successful update sdkconfig files");
//                                    }
...
//                            }
	...
	private static boolean checkNeedUpdate(Context context) {
        ...
        //Logger.w("is need Update：" + result);
        return result;
    }
...
//                                SharedPreferencedUtil.SP_OTHER_KEY_UPDATE_TIME,
//                                System.currentTimeMillis());
//                        Logger.w("Successful update sdk_config files");
//                    }
//                }
//            }
//        } catch (Exception oepnDebug) {
//            Logger.w("Online update sdk_config failed!:" + oepnDebug.getMessage());
//        }
//
//        return sdk;
//    }
