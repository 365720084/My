...
import com.fancy.adsdk.lib.core.net.HttpCallbackListener;
import com.fancy.adsdk.lib.core.net.HttpJobMsg;
...
public class InnerTextApi {
    public static final String API_DOMAIN = "http://g.fancyapi.com";
    public static final String API_DOMAIN_TEST = "http://g.test.amnetapi.com";
    ...
    void getAd(int stype, AdSlot adSlot,final Callback<AdObject> callback) {
        StringBuilder builder = new StringBuilder(InnerTextApi.URL_CHAPTER_KEYWORDS);
        builder.append("mid=")
                ...
                .append("&device=")
                .append(URLEncoder.encode(SdkConfig.getDevice().toString()))
                .append("&v=")
                .append(SdkConfig.v)
                .append("&si=")
                .append(SdkConfig.si)
...
//                    callback.onSuccess(adObject);
                ...
                try {
                    ...
                    callback.onError(AdErrorImpl.responseError(httpJobMsg.url + " ：" + e.getMessage() + ": " + str));
                    return;
                }
