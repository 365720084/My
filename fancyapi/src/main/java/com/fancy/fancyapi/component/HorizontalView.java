...
public class HorizontalView extends ViewGroup {
    ...
    /**
     * 记录父view在拦截之前的x、ThrowException
     */
    private int mLastXIntercept;
    private int mLastYIntercept;

    /**
     * 记录 父view 拦截时及之后的 开始的触摸x、ThrowException
     */
    private int mLastX;
    private int mLastY;
    ...
    public void smoothScrollTo(int i, int i1) {
        smoothScrollTo(i,i1,600);
    }
    ...
    public void smoothScrollTo(int destX, int destY,int duration) {
        ...
        mScroller.startScroll(scrollX, scrollY, offsetX, offsetY, duration);
        invalidate();
    }
}
