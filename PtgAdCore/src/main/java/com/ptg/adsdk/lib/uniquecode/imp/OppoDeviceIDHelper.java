package com.ptg.adsdk.lib.uniquecode.imp;
...
import com.ptg.adsdk.lib.uniquecode.interfaces.OppoIDInterface;
...
public class OppoDeviceIDHelper {
    ...
    ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            oppoIDInterface = OppoIDInterface.Stub.genInterface(service);
        }
