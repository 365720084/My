package com.ptg.adsdk.lib.uniquecode.interfaces;
...
public interface ZTEIDInterface extends IInterface {
    ...
    abstract class Stub extends Binder implements ZTEIDInterface {
    }

    public static class Proxy implements ZTEIDInterface {
        private IBinder binder;

        public Proxy(IBinder b) {
            binder = b;
        }
